                ...
                <div className="dropdown dropdown-hover">
                    ...
                    <ul className="dropdown-content menu bg-primary z-[1] w-206 p-2 shadow">
                        <li>
                            <button
                                onClick={() =>
                                    switchTab("overview/tracks/7day")
                                }
                            >
                                7 days
                            </button>
                        ...
                        <li>
                            <button
                                onClick={() =>
                                    switchTab("overview/tracks/1month")
                                }
                            >
                                1 month
                            </button>
                        ...
                        <li>
                            <button
                                onClick={() =>
                                    switchTab("overview/tracks/3month")
                                }
                            >
                                3 months
                            </button>
                        ...
                        <li>
                            <button
                                onClick={() =>
                                    switchTab("overview/tracks/6month")
                                }
                            >
                                6 months
                            </button>
                        ...
                        <li>
                            <button
                                onClick={() =>
                                    switchTab("overview/tracks/12month")
                                }
                            >
                                12 months
                            </button>
                        ...
                        <li>
                            <button
                                onClick={() =>
                                    switchTab("overview/tracks/overall")
                                }
                            >
                                overall
                            </button>
